...
def click_to_set_corners(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if len(calibration_points) == 4 and homography_matrix is None:
            ...
            # ◆◆◆ DO NOT add any hardcoded center obstacle ◆◆◆
...
# (Optional) These functions remain in case you want manual obstacle testing:
...
def process_frames():
    ...
    while not stop_event.is_set():
        ...
        if homography_matrix is not None:
            ...
            # Overwrite obstacles with just the cross
