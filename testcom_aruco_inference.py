...
# Function to detect ArUco marker and return position + heading
...
# Replace send_path to apply filter before sending
def send_path(grid_path: list, heading: float):
    global robot_sock
    ...
    try:
        ...
        # Send deliver command after path
